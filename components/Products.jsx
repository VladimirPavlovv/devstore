...
export default function Products(props) {
    ...
    return (
        < >
                ...
                <div className="planner-container">
                    <div>
                        <button onClick={() => {
                            ...
                            <img src="low_res/planner.jpeg" alt="low-res-planner" />
                        </button>
                    </div>
                    <div className="planner-info">
                        ...
                        <p>Step into a realm of fantasy and organization with our <strong>Medieval Dragon Month Planner</strong>!
                         This high-resolution PNG asset combines the fierce elegance of dragons with intricate medieval designs to create a planner
                          that's not only functional but also a work of art. 
            ...
            <div id="stickers-id" className="section-container">
                <div className="section-header">
